...
const STRINGS = {
  ca: {
    ...
    "modal.weapon": "Arma",
    "modal.noDetails":
      "La Sara encara no comparteix els detalls d'aquest personatge dins del joc ✦",
    "modal.close": "Tancar",
  ...
  es: {
    ...
    "modal.weapon": "Arma",
    "modal.noDetails": "Sara aún no comparte los detalles de este personaje dentro del juego ✦",
    "modal.close": "Cerrar",
  ...
  en: {
    ...
    "modal.weapon": "Weapon",
    "modal.noDetails": "Sara doesn't share this character's in-game details yet ✦",
    "modal.close": "Close",
  ...
  fr: {
    ...
    "modal.weapon": "Arme",
    "modal.noDetails": "Sara ne partage pas encore les détails de ce personnage en jeu ✦",
    "modal.close": "Fermer",
