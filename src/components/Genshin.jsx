...
export default function Genshin({ genshin }) {
  ...
  const { player, characters = [], uid, updatedAt } = genshin;
  ...
  return (
    <section id="genshin" className="section">
      ...
      <div className="char-grid">
        {characters.map((c) => (
          <div className={`char-card element-${c.element ?? "none"}`} key={c.id}>
      ...
      <p className="genshin-updated">
        ...
        <a href="https://enka.network/u/701046437/" target="_blank" rel="noreferrer">
          Enka.Network
        </a>
      </p>
    </section>
